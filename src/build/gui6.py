...
def gui_6_hide_exe_success(window, main_frame):

    def get_base_path():
        if hasattr(sys, "_MEIPASS"):
            return Path(sys._MEIPASS) / "assets" / "frame6"
        return Path(__file__).parent / "assets" / "frame6"
    ...
    button_1 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: show_page_extract_exe(), # Extract secret page
        relief="flat"
    )
    button_1.place(
        x=232.0,
