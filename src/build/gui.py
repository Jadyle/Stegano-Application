...
def gui_1_hide(window, main_frame):
    ...
    def show_page_hide_success():
        page_hide_frame = tk.Frame(main_frame)
        
        from build.gui4 import gui_4_hide_success
        gui_4_hide_success(window, main_frame)
    ...
    def hide_message():
        try:
            ...
            result = encode_message(image_path, message, output_path)
            ...
            if result == True or result is None:  # Adjust based on your encode_message behavior
                ...
                show_page_hide_success()  # Show success page only on success
            else:
    ...
    button_1.config(command=select_image)

    # Update button_1 to call hide_message when clicked
    button_2.config(command=hide_message)
